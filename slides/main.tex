...
\begin{frame}{The pipeline today: three stages}
  ...
  lookup. The model is \emph{never} trusted to write the
  clock/\texttt{disable iff}/label itself -- these are added automatically
  once the bare expression is finalized.
  \end{card}
\end{frame}
