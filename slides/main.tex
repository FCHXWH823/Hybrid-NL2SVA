...
\begin{frame}[plain]
  \begin{tikzpicture}[remember picture, overlay]
    \node[anchor=south west, xshift=0.7cm, yshift=0.45cm] at (current page.south west) {\includegraphics[width=2.1cm]{Figs/nyu_logo.pdf}};
  \end{tikzpicture}
  \vspace{6pt}
  \begin{center}
    {\usebeamerfont{title}\color{nyuviolet}\Huge\bfseries\inserttitle}\\[8pt]
    {\usebeamerfont{subtitle}\color{nyumuted}\large\insertsubtitle}\\[16pt]
    ...
    {\scriptsize\color{nyumuted}Builds on Xiao, Ekberg, Garg, Karri,
    \href{https://doi.org/10.1109/MLCAD65511.2025.11189208}{\underline{Hybrid-NL2SVA}}, MLCAD 2025.}
  \end{center}
\end{frame}
