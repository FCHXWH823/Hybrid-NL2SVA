...
\begin{frame}{The anatomy of an SVA}
...
\begin{frame}{As published: the overall pipeline}
  \framesubtitle{The customized RAG framework, TCAD paper Fig.~2}
  \centering
...
\begin{frame}{Stage 2 in detail: HybridRetrieval-augmented generation}
  \framesubtitle{Two independent retrieval paths feed one generation call -- TCAD paper Fig.~3}
  \centering
...
\begin{frame}{As published: SVA operator-based rechecking}
  \framesubtitle{TCAD paper Fig.~5 -- the originally published SOR mechanism}
  \centering
  ...
  recomposition of the assertion's meaning, catching mismatches the
