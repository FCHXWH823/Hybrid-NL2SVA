...
# Settings
labels = ['LLM', 'nl2spec', 'Spec2Assertion', 'SOR','RAGSVAG']
x = np.arange(len(labels))
width = 0.4  # bar width

# Data
openai_sc = [178, 208, 173, 176, 207]
openai_fm = [101, 110, 108, 132, 160]
codex_sc = [208, 216, 182, 206, 211]
codex_fm = [110, 130, 138, 132, 148]
deepseek_sc = [210, 210, 191, 215, 216]
deepseek_fm = [174, 160, 160, 190, 193]
...
# gs  = gridspec.GridSpec(2, 2, height_ratios=[1, 1])   # 2×2 grid
gs  = gridspec.GridSpec(2, 4, wspace=0.35, hspace=0.2)
axes = []

# First row: two side-by-side axes
axes.append(fig.add_subplot(gs[0, :2]))
axes.append(fig.add_subplot(gs[0, 2:]))

# Second row: one axis spanning both columns (centre)
...
# -----------------------------------------------------------
axes[0].set_ylabel('Number of Assertions', fontsize=14)
axes[2].set_ylabel('Number of Assertions', fontsize=14)
