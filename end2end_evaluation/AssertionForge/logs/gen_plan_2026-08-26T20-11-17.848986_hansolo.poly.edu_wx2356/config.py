...
if task == 'gen_plan':
    ...
    if subtask == 'actual_gen':
        ...
        if design_name == 'apb':
            ...
            file_path = '/tmp/claude-4479046/-home-wx2356/ad92df64-1dd8-491b-840c-3fdf42feccac/scratchpad/AssertLLM/spec/uart.pdf'
            design_dir = (
                '/tmp/claude-4479046/-home-wx2356/ad92df64-1dd8-491b-840c-3fdf42feccac/scratchpad/AssertLLM/rtl/uart'
            )
            KG_path = '/tmp/claude-4479046/-home-wx2356/ad92df64-1dd8-491b-840c-3fdf42feccac/scratchpad/AssertLLM/spec/graph_rag_uart/output/clustered_graph.0.graphml'
    ...
    if design_name == 'apb':
        ...
        input_file_path = (
            '/tmp/claude-4479046/-home-wx2356/ad92df64-1dd8-491b-840c-3fdf42feccac/scratchpad/AssertLLM/spec/uart.pdf'
        )
    elif design_name == 'sockit':
        input_file_path = (
    ...
    env_source_path = '/tmp/claude-4479046/-home-wx2356/ad92df64-1dd8-491b-840c-3fdf42feccac/scratchpad/rag_template/.env'

    settings_source_path = (
        '/tmp/claude-4479046/-home-wx2356/ad92df64-1dd8-491b-840c-3fdf42feccac/scratchpad/rag_template/settings.yaml'
    )

    # entity_extraction_prompt_source_path = '/<path>/<to>/rag_apb/prompts/entity_extraction_vanilla_graphRAG.txt'  # original/baseline
    entity_extraction_prompt_source_path = f'/tmp/claude-4479046/-home-wx2356/ad92df64-1dd8-491b-840c-3fdf42feccac/scratchpad/AssertionForge/entity_extraction.txt'  # better- customized for HW
...
graphrag_local_dir = '/tmp/claude-4479046/-home-wx2356/ad92df64-1dd8-491b-840c-3fdf42feccac/scratchpad/graphrag'  # point to your local GraphRAG repo
...
)  # Adjusted: our clone is <repo>/src/config.py (parents[1] = repo root with .git),
